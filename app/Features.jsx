  ...
  return (
    <article className="border-b lg:border-none lg:max-w-5xl lg:mx-auto">
        <div className="my-8 mx-2 md:flex md:gap-2 lg:gap-4">
          <section>
            <Image
              className="mx-auto lg:w-full lg:h-3/5"
              ...
              width={350}
            />
            <h3 className="uppercase font-semibold text-lg mt-8 mb-2">Feature 1</h3>
            <p className="pr-4">
              Talk about some of the details of your offer with a focus on the value
              people get back.
            </p>
          </section>
          <section>
            <Image
              ...
              width={350}
            />
            <h3 className="uppercase font-semibold text-lg mt-8 mb-2">Feature 2</h3>
            <p className="pr-4">
              Is there a pain point that your service resolves? Tell visitors about
              it here.
            </p>
          </section>
          <section>
            <Image
              ...
              width={350}
            />
            <h3 className="uppercase font-semibold text-lg mt-8 mb-2">Feature 3</h3>
            <p className="pr-4">
